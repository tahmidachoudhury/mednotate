    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage your medical notes and templates</p>
        </div>
            ...
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <Card key={i}>
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      <CardTitle className="text-base">
                        {i % 3 === 0 ? "SOAP Note" : i % 3 === 1 ? "Progress Note" : "BIRP Note"}
                      </CardTitle>
                      <CardDescription>
                        Patient #{100 + i} • {i % 2 === 0 ? "Draft" : "Completed"}
                      </CardDescription>
                    </div>
                    <div
                ...
                <CardFooter className="flex justify-between border-t pt-4">
                  <div className="text-xs text-muted-foreground">Last edited: April {i + 5}, 2025</div>
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <CardDescription>Patient #{100 + i} • Draft</CardDescription>
                    </div>
                    <div className="rounded-full bg-yellow-100 px-2 py-0.5 text-xs text-yellow-800">Draft</div>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="line-clamp-3 text-sm text-muted-foreground">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[2, 4, 6].map((i) => (
              <Card key={i}>
                <CardHeader className="pb-2">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <CardDescription>Patient #{100 + i} • Completed</CardDescription>
                    </div>
                ...
                <CardFooter className="flex justify-between border-t pt-4">
                  <div className="text-xs text-muted-foreground">Completed: April {i + 5}, 2025</div>
                  <div className="flex gap-1">
                    <Button variant="ghost" size="icon">
            ...
            {["SOAP", "DAP", "BIRP", "Progress"].map((template) => (
              <Card key={template}>
                <CardHeader>
                  ...
                  <CardDescription>Standard {template} note template</CardDescription>
                </CardHeader>
                <CardContent>
